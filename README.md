[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 702 | 🐛 6 | 📅 2026-09-20
...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 497 | 🐛 0 | 🌐 Python | 📅 2026-08-09
...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 433 | 🐛 16 | 🌐 Rust | 📅 2026-09-21
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26
* Go
  * Scheduler (v5): [go-fsrs](https://github.com/open-spaced-repetition/go-fsrs) ⭐ 146 | 🐛 4 | 🌐 Go | 📅 2026-07-25
* Java
  * Scheduler (v5): [rs-fsrs-java](https://github.com/open-spaced-repetition/rs-fsrs-java) ⭐ 21 | 🐛 2 | 🌐 Rust | 📅 2026-02-03
* Scala
...
* Dart
  * Scheduler (v4.5): [dart-fsrs](https://github.com/open-spaced-repetition/dart-fsrs) ⭐ 66 | 🐛 5 | 🌐 Dart | 📅 2025-06-20
* Swift
  * Scheduler (v5): [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 102 | 🐛 6 | 🌐 Swift | 📅 2026-05-25
* Clojure/ClojureScript
  * Scheduler (v4): [cljc-fsrs](https://github.com/open-spaced-repetition/cljc-fsrs) ⭐ 17 | 🐛 1 | 🌐 Clojure | 📅 2025-09-25
* Ruby
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,989 | 🐛 295 | 🌐 Rust | 📅 2026-09-25.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 497 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 433 | 🐛 16 | 🌐 Rust | 📅 2026-09-21 via swift-bridge FFI.

#### [Flipnem](https://flipnem.com/)

An Anki compatible online Flashcard platform that supports PWA install.

* FSRS scheduled flashcard reviews that rely on [rs-fsrs](https://github.com/open-spaced-repetition/rs-fsrs) ⭐ 51 | 🐛 3 | 🌐 Rust | 📅 2026-07-20
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 for FSRS-6 scheduling with the default weights, across per-topic, per-subject and cross-subject due queues.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 10 | 🐛 23 | 🌐 Rust | 📅 2026-09-25
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 433 | 🐛 16 | 🌐 Rust | 📅 2026-09-21 for FSRS-6 scheduling.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,874 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-26 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26.
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 497 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
Logseq uses [cljc-fsrs](https://github.com/open-spaced-repetition/cljc-fsrs) ⭐ 17 | 🐛 1 | 🌐 Clojure | 📅 2025-09-25 in its database version.
...
* [LearnKit](https://github.com/ctrlaltwill/LearnKit) ⭐ 177 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-14 helps you remember what you write. It brings flashcards, note review, tests, and AI-assisted study tools into Obsidian, so your vault becomes a place to learn, not just store information. It uses FSRS-6 for spaced repetition scheduling.

* [True Recall](https://github.com/pieralukasz/true-recall) ⭐ 64 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-25 is a next-gen spaced repetition system for Obsidian with AI card generation, local-first SQLite storage, Anki import/export, projects system, and comprehensive analytics. It uses FSRS-6 via [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,516 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-26
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,664 | 🐛 1,174 | 🌐 JavaScript | 📅 2026-09-21
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 129 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-26

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 798 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 to schedule reviews (no learning steps, day-level scheduling); a word whose scheduled interval reaches a configurable threshold is marked mastered.
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 497 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
* Benchmark: [open-spaced-repetition/srs-benchmark: A benchmark for spaced repetition schedulers/algorithms (github.com)](https://github.com/open-spaced-repetition/srs-benchmark) ⭐ 267 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-09-18
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 702 | 🐛 6 | 📅 2026-09-20
* Dataset:
...
* Code:
  * [maimemo/SSP-MMC: A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling](https://github.com/maimemo/SSP-MMC) ⭐ 224 | 🐛 0 | 🌐 Python | 📅 2025-11-28
...
* GitHub repository: [duolingo/halflife-regression](https://github.com/duolingo/halflife-regression) ⭐ 580 | 🐛 6 | 🌐 Python | 📅 2024-04-20
* Paper: [A Trainable Spaced Repetition Model for Language Learning](https://github.com/duolingo/halflife-regression/blob/master/settles.acl16.pdf) ⭐ 580 | 🐛 6 | 🌐 Python | 📅 2024-04-20
