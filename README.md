[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 694 | 🐛 6 | 📅 2026-09-11
...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 491 | 🐛 0 | 🌐 Python | 📅 2026-08-09
...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 428 | 🐛 12 | 🌐 Rust | 📅 2026-09-18
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18
* Go
...
* Dart
  * Scheduler (v4.5): [dart-fsrs](https://github.com/open-spaced-repetition/dart-fsrs) ⭐ 65 | 🐛 5 | 🌐 Dart | 📅 2025-06-20
* Swift
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,974 | 🐛 290 | 🌐 Rust | 📅 2026-09-18.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 491 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 428 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 via swift-bridge FFI.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18 for FSRS-6 scheduling with the default weights, across per-topic, per-subject and cross-subject due queues.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 10 | 🐛 24 | 🌐 Rust | 📅 2026-09-18
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 428 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 for FSRS-6 scheduling.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,744 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-18 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18.
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 491 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
* [HiNote](https://github.com/CatMuse/HiNote) ⭐ 258 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-18 is a powerful Obsidian extension that helps you add comments to highlighted notes, use AI for thinking, and FSRS-6 for memory.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,418 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-18
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,655 | 🐛 1,175 | 🌐 JavaScript | 📅 2026-09-16
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 125 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 792 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-18 to schedule reviews (no learning steps, day-level scheduling); a word whose scheduled interval reaches a configurable threshold is marked mastered.
* Chinese UI only. [Source on GitHub](https://github.com/leoon-hu/jiaci) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 (MIT; Next.js + PostgreSQL).
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 491 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
* Benchmark: [open-spaced-repetition/srs-benchmark: A benchmark for spaced repetition schedulers/algorithms (github.com)](https://github.com/open-spaced-repetition/srs-benchmark) ⭐ 264 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-09-18
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 694 | 🐛 6 | 📅 2026-09-11
* Dataset:
...
* GitHub repository: [duolingo/halflife-regression](https://github.com/duolingo/halflife-regression) ⭐ 578 | 🐛 6 | 🌐 Python | 📅 2024-04-20
* Paper: [A Trainable Spaced Repetition Model for Language Learning](https://github.com/duolingo/halflife-regression/blob/master/settles.acl16.pdf) ⭐ 578 | 🐛 6 | 🌐 Python | 📅 2024-04-20
