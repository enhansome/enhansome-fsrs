...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 476 | 🐛 0 | 🌐 Python | 📅 2026-08-09
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 769 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25
* Go
  * Scheduler (v5): [go-fsrs](https://github.com/open-spaced-repetition/go-fsrs) ⭐ 143 | 🐛 4 | 🌐 Go | 📅 2026-07-25
* Java
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,899 | 🐛 281 | 🌐 Rust | 📅 2026-08-25.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 476 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 411 | 🐛 6 | 🌐 Rust | 📅 2026-08-06 via swift-bridge FFI.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 769 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 769 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25.
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 476 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,005 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-27
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,633 | 🐛 1,156 | 🌐 JavaScript | 📅 2026-08-25
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 110 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 769 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 769 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 476 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
WordVault is a word study app for Scrabble/Boggle/other word games. It [uses the Go FSRS library](https://github.com/open-spaced-repetition/go-fsrs) ⭐ 143 | 🐛 4 | 🌐 Go | 📅 2026-07-25 for scheduling words, which show up as scrambled letters for the user to solve. This should hopefully be significally more efficient than the Leitner cardbox system previously in use in some word study apps.
