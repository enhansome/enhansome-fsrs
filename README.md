...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 413 | 🐛 6 | 🌐 Rust | 📅 2026-08-29
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 477 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 413 | 🐛 6 | 🌐 Rust | 📅 2026-08-29 via swift-bridge FFI.
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 413 | 🐛 6 | 🌐 Rust | 📅 2026-08-29 for FSRS-6 scheduling.
