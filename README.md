[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 686 | 🐛 6 | 📅 2026-09-11
...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 422 | 🐛 6 | 🌐 Rust | 📅 2026-09-08
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14
* Go
...
* Swift
  * Scheduler (v5): [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 101 | 🐛 6 | 🌐 Swift | 📅 2026-05-25
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,966 | 🐛 289 | 🌐 Rust | 📅 2026-09-10.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 422 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 via swift-bridge FFI.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 for FSRS-6 scheduling with the default weights, across per-topic, per-subject and cross-subject due queues.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 10 | 🐛 26 | 🌐 Rust | 📅 2026-09-14
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 422 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 for FSRS-6 scheduling.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,670 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-14 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14.
...
Revu uses [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 101 | 🐛 6 | 🌐 Swift | 📅 2026-05-25.
...
* [LearnKit](https://github.com/ctrlaltwill/LearnKit) ⭐ 173 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-14 helps you remember what you write. It brings flashcards, note review, tests, and AI-assisted study tools into Obsidian, so your vault becomes a place to learn, not just store information. It uses FSRS-6 for spaced repetition scheduling.

* [True Recall](https://github.com/pieralukasz/true-recall) ⭐ 62 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 is a next-gen spaced repetition system for Obsidian with AI card generation, local-first SQLite storage, Anki import/export, projects system, and comprehensive analytics. It uses FSRS-6 via [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,342 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,651 | 🐛 1,167 | 🌐 JavaScript | 📅 2026-09-13
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 123 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-14 to schedule reviews (no learning steps, day-level scheduling); a word whose scheduled interval reaches a configurable threshold is marked mastered.
* Chinese UI only. [Source on GitHub](https://github.com/leoon-hu/jiaci) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 (MIT; Next.js + PostgreSQL).
...
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 686 | 🐛 6 | 📅 2026-09-11
* Dataset:
