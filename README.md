[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 697 | 🐛 5 | 📅 2026-09-20
...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 493 | 🐛 0 | 🌐 Python | 📅 2026-08-09
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20
* Go
...
* Kotlin
  * Scheduler (v6): [FSRS-Kotlin](https://github.com/open-spaced-repetition/FSRS-Kotlin) ⭐ 28 | 🐛 1 | 🌐 Kotlin | 📅 2025-08-07
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,975 | 🐛 290 | 🌐 Rust | 📅 2026-09-18.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 493 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 429 | 🐛 12 | 🌐 Rust | 📅 2026-09-18 via swift-bridge FFI.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20 for FSRS-6 scheduling with the default weights, across per-topic, per-subject and cross-subject due queues.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 10 | 🐛 30 | 🌐 Rust | 📅 2026-09-20
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,772 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-20 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20.
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 493 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
* [HiNote](https://github.com/CatMuse/HiNote) ⭐ 258 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-20 is a powerful Obsidian extension that helps you add comments to highlighted notes, use AI for thinking, and FSRS-6 for memory.

* [obsidian-spaced-repetition-recall](https://github.com/open-spaced-repetition/obsidian-spaced-repetition-recall) ⭐ 210 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-19 is a modified version of obsidian-spaced-repetition and merging recall plugin to use seperate json data file. It uses FSRS-6.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,439 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-20
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,657 | 🐛 1,175 | 🌐 JavaScript | 📅 2026-09-16
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 126 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 794 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-20 to schedule reviews (no learning steps, day-level scheduling); a word whose scheduled interval reaches a configurable threshold is marked mastered.
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 493 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
* Benchmark: [open-spaced-repetition/srs-benchmark: A benchmark for spaced repetition schedulers/algorithms (github.com)](https://github.com/open-spaced-repetition/srs-benchmark) ⭐ 264 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-09-18
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 697 | 🐛 5 | 📅 2026-09-20
* Dataset:
...
* Code:
  * [maimemo/SSP-MMC: A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling](https://github.com/maimemo/SSP-MMC) ⭐ 223 | 🐛 0 | 🌐 Python | 📅 2025-11-28
