[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 688 | 🐛 6 | 📅 2026-09-11
...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 490 | 🐛 0 | 🌐 Python | 📅 2026-08-09
...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 425 | 🐛 14 | 🌐 Rust | 📅 2026-09-16
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16
* Go
...
* Swift
  * Scheduler (v5): [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 102 | 🐛 6 | 🌐 Swift | 📅 2026-05-25
...
* Lisp
  * Scheduler (v6): [lisp-fsrs](https://github.com/open-spaced-repetition/lisp-fsrs) ⭐ 32 | 🐛 0 | 🌐 Common Lisp | 📅 2025-11-19
* Haskell
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,968 | 🐛 290 | 🌐 Rust | 📅 2026-09-15.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 490 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 425 | 🐛 14 | 🌐 Rust | 📅 2026-09-16 via swift-bridge FFI.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16 for FSRS-6 scheduling with the default weights, across per-topic, per-subject and cross-subject due queues.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 10 | 🐛 21 | 🌐 Rust | 📅 2026-09-16
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 425 | 🐛 14 | 🌐 Rust | 📅 2026-09-16 for FSRS-6 scheduling.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,696 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-16 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16.
...
Revu uses [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 102 | 🐛 6 | 🌐 Swift | 📅 2026-05-25.
...
#### [spacedrep](https://github.com/wpwilson10/spacedrep) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-04-26
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 490 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
* [HiNote](https://github.com/CatMuse/HiNote) ⭐ 258 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-16 is a powerful Obsidian extension that helps you add comments to highlighted notes, use AI for thinking, and FSRS-6 for memory.
...
* [LearnKit](https://github.com/ctrlaltwill/LearnKit) ⭐ 173 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 helps you remember what you write. It brings flashcards, note review, tests, and AI-assisted study tools into Obsidian, so your vault becomes a place to learn, not just store information. It uses FSRS-6 for spaced repetition scheduling.

* [True Recall](https://github.com/pieralukasz/true-recall) ⭐ 63 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-15 is a next-gen spaced repetition system for Obsidian with AI card generation, local-first SQLite storage, Anki import/export, projects system, and comprehensive analytics. It uses FSRS-6 via [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,394 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-16
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,653 | 🐛 1,170 | 🌐 JavaScript | 📅 2026-09-15
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 123 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 791 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-16 to schedule reviews (no learning steps, day-level scheduling); a word whose scheduled interval reaches a configurable threshold is marked mastered.
* Chinese UI only. [Source on GitHub](https://github.com/leoon-hu/jiaci) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 (MIT; Next.js + PostgreSQL).
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 490 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 688 | 🐛 6 | 📅 2026-09-11
* Dataset:
...
* Code:
  * [maimemo/SSP-MMC: A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling](https://github.com/maimemo/SSP-MMC) ⭐ 222 | 🐛 0 | 🌐 Python | 📅 2025-11-28
