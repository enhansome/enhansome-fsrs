[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 685 | 🐛 5 | 📅 2026-09-11
...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-08-09
  * Optimizer (v6): [fsrs-optimizer](https://github.com/open-spaced-repetition/fsrs-optimizer) ⭐ 112 | 🐛 2 | 🌐 Python | 📅 2026-08-06
  * Optimizer (v6): [fsrs-rs-python](https://github.com/open-spaced-repetition/fsrs-rs-python) ⭐ 37 | 🐛 2 | 🌐 Rust | 📅 2026-09-07
...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 421 | 🐛 6 | 🌐 Rust | 📅 2026-09-08
    * Run in browsers: [fsrs-browser](https://github.com/open-spaced-repetition/fsrs-browser) ⭐ 54 | 🐛 0 | 🌐 Rust | 📅 2026-06-14
  * Scheduler (v5): [rs-fsrs](https://github.com/open-spaced-repetition/rs-fsrs) ⭐ 50 | 🐛 3 | 🌐 Rust | 📅 2026-07-20
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11
* Go
  * Scheduler (v5): [go-fsrs](https://github.com/open-spaced-repetition/go-fsrs) ⭐ 145 | 🐛 4 | 🌐 Go | 📅 2026-07-25
* Java
  * Scheduler (v5): [rs-fsrs-java](https://github.com/open-spaced-repetition/rs-fsrs-java) ⭐ 20 | 🐛 2 | 🌐 Rust | 📅 2026-02-03
* Scala
  * Scheduler (v6): [fsrs4s](https://github.com/jwbargsten/fsrs4s) ⭐ 2 | 🐛 0 | 🌐 Scala | 📅 2026-03-13
* C
  * Scheduler (v5): [rs-fsrs-c](https://github.com/open-spaced-repetition/rs-fsrs-c) ⭐ 8 | 🐛 0 | 🌐 Rust | 📅 2025-06-11
* Nodejs
  * Scheduler (v5): [rs-fsrs-nodejs](https://github.com/open-spaced-repetition/rs-fsrs-nodejs) ⭐ 3 | 🐛 3 | 🌐 Rust | 📅 2026-01-23
* Dart
  * Scheduler (v4.5): [dart-fsrs](https://github.com/open-spaced-repetition/dart-fsrs) ⭐ 64 | 🐛 5 | 🌐 Dart | 📅 2025-06-20
* Swift
  * Scheduler (v5): [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 100 | 🐛 6 | 🌐 Swift | 📅 2026-05-25
...
* Kotlin
  * Scheduler (v6): [FSRS-Kotlin](https://github.com/open-spaced-repetition/FSRS-Kotlin) ⭐ 27 | 🐛 1 | 🌐 Kotlin | 📅 2025-08-07
  * Scheduler (v4): [android-fsrs](https://github.com/open-spaced-repetition/android-fsrs) ⭐ 19 | 🐛 0 | 🌐 Kotlin | 📅 2023-10-17
* Elixir
...
* Lisp
  * Scheduler (v6): [lisp-fsrs](https://github.com/open-spaced-repetition/lisp-fsrs) ⭐ 31 | 🐛 0 | 🌐 Common Lisp | 📅 2025-11-19
* Haskell
  * Scheduler (v7): [haskell-fsrs](https://github.com/kutyel/haskell-fsrs) ⭐ 3 | 🐛 0 | 🌐 Haskell | 📅 2026-08-21
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,960 | 🐛 289 | 🌐 Rust | 📅 2026-09-10.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 421 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 via swift-bridge FFI.

#### [Flipnem](https://flipnem.com/)

An Anki compatible online Flashcard platform that supports PWA install.

* FSRS scheduled flashcard reviews that rely on [rs-fsrs](https://github.com/open-spaced-repetition/rs-fsrs) ⭐ 50 | 🐛 3 | 🌐 Rust | 📅 2026-07-20
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11 for FSRS-6 scheduling with the default weights, across per-topic, per-subject and cross-subject due queues.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 10 | 🐛 22 | 🌐 Rust | 📅 2026-09-13
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 421 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 for FSRS-6 scheduling.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,660 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-13 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11.
...
Revu uses [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 100 | 🐛 6 | 🌐 Swift | 📅 2026-05-25.
...
#### [spacedrep](https://github.com/wpwilson10/spacedrep) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-04-26
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
Logseq uses [cljc-fsrs](https://github.com/open-spaced-repetition/cljc-fsrs) ⭐ 17 | 🐛 0 | 🌐 Clojure | 📅 2025-09-25 in its database version.
...
* [HiNote](https://github.com/CatMuse/HiNote) ⭐ 258 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-13 is a powerful Obsidian extension that helps you add comments to highlighted notes, use AI for thinking, and FSRS-6 for memory.

* [obsidian-spaced-repetition-recall](https://github.com/open-spaced-repetition/obsidian-spaced-repetition-recall) ⭐ 210 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-05 is a modified version of obsidian-spaced-repetition and merging recall plugin to use seperate json data file. It uses FSRS-6.

* [LearnKit](https://github.com/ctrlaltwill/LearnKit) ⭐ 171 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-06 helps you remember what you write. It brings flashcards, note review, tests, and AI-assisted study tools into Obsidian, so your vault becomes a place to learn, not just store information. It uses FSRS-6 for spaced repetition scheduling.

* [True Recall](https://github.com/pieralukasz/true-recall) ⭐ 62 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-11 is a next-gen spaced repetition system for Obsidian with AI card generation, local-first SQLite storage, Anki import/export, projects system, and comprehensive analytics. It uses FSRS-6 via [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11.
...
#### [Org-fc](https://github.com/l3kn/org-fc) ⭐ 295 | 🐛 35 | 🌐 Emacs Lisp | 📅 2026-01-17
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,324 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-13
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,647 | 🐛 1,166 | 🌐 JavaScript | 📅 2026-09-13
...
FSRS is available as a fork of the Tidme plugin for TiddlyWiki: [fsrs4tw](https://github.com/open-spaced-repetition/fsrs4tw) ⭐ 14 | 🐛 1 | 🌐 JavaScript | 📅 2023-12-24
...
* ZKMemo integrates FSRS-6, implemented using the [srs-everything](https://github.com/jiangege/srs-everything) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2025-07-04.
* [Getting Started](https://help.zkmemo.com/getting-started.html)

### Incremental Reading

#### [Foliole](https://github.com/campfirium/foliole) ⭐ 121 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
#### [HSRS](https://github.com/satchelspencer/hsrs) ⭐ 36 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07
...
* Uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 788 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-11 to schedule reviews (no learning steps, day-level scheduling); a word whose scheduled interval reaches a configurable threshold is marked mastered.
* Chinese UI only. [Source on GitHub](https://github.com/leoon-hu/jiaci) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 (MIT; Next.js + PostgreSQL).
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
WordVault is a word study app for Scrabble/Boggle/other word games. It [uses the Go FSRS library](https://github.com/open-spaced-repetition/go-fsrs) ⭐ 145 | 🐛 4 | 🌐 Go | 📅 2026-07-25 for scheduling words, which show up as scrambled letters for the user to solve. This should hopefully be significally more efficient than the Leitner cardbox system previously in use in some word study apps.
...
* Benchmark: [open-spaced-repetition/srs-benchmark: A benchmark for spaced repetition schedulers/algorithms (github.com)](https://github.com/open-spaced-repetition/srs-benchmark) ⭐ 263 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-09-12
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 685 | 🐛 5 | 📅 2026-09-11
* Dataset:
...
* Code:
  * [maimemo/SSP-MMC: A Stochastic Shortest Path Algorithm for Optimizing Spaced Repetition Scheduling](https://github.com/maimemo/SSP-MMC) ⭐ 221 | 🐛 0 | 🌐 Python | 📅 2025-11-28
  * [maimemo/SSP-MMC-Plus: Optimizing Spaced Repetition Schedule by Capturing the Dynamics of Memory](https://github.com/maimemo/SSP-MMC-Plus) ⭐ 72 | 🐛 0 | 🌐 Python | 📅 2024-03-14
* Paper:
...
* Science popularization video:
  * [【墨墨科普】为了搞懂艾宾浩斯记忆法的虚假与真相，我回到了 1885 年……\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1yF411s7SN/)
  * [【墨墨科普】降维打击！别用艾宾浩斯记忆法了，试试这个吧！\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1mL4y1P7bh/)
  * [【墨墨科普】几个公式，拯救你的记忆。\_哔哩哔哩\_bilibili](https://www.bilibili.com/video/BV1Xe4y1t7Mi/)
...
* GitHub repository: [duolingo/halflife-regression](https://github.com/duolingo/halflife-regression) ⭐ 577 | 🐛 6 | 🌐 Python | 📅 2024-04-20
* Paper: [A Trainable Spaced Repetition Model for Language Learning](https://github.com/duolingo/halflife-regression/blob/master/settles.acl16.pdf) ⭐ 577 | 🐛 6 | 🌐 Python | 📅 2024-04-20
