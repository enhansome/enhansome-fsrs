[<img src="https://github.com/open-spaced-repetition/fsrs4anki/assets/32575846/9efb2ca5-51bd-411d-9694-a77b09f51fa7" align="left" width="64" height="64">](https://github.com/open-spaced-repetition/awesome-fsrs) ⭐ 681 | 🐛 6 | 📅 2026-09-01
...
* Python
  * Scheduler (v6) + Optimizer: [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 481 | 🐛 0 | 🌐 Python | 📅 2026-08-09
...
* Rust
  * Scheduler (v6) + Optimizer: [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 416 | 🐛 6 | 🌐 Rust | 📅 2026-09-08
...
* TypeScript
  * Scheduler (v6): [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09
* Go
...
* Swift
  * Scheduler (v5): [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 99 | 🐛 6 | 🌐 Swift | 📅 2026-05-25
...
* Avorio uses its own FSRS-5 implementation in a shared Rust core, exposed to SwiftUI through [UniFFI](https://github.com/mozilla/uniffi-rs) ⭐ 4,943 | 🐛 286 | 🌐 Rust | 📅 2026-09-09.
...
Discito uses its own Swift FSRS-6 port (validated for parity against [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 481 | 🐛 0 | 🌐 Python | 📅 2026-08-09), with the parameter optimizer bridging [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 416 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 via swift-bridge FFI.
...
#### [Origa](https://github.com/yurvon-screamo/origa) ⭐ 8 | 🐛 23 | 🌐 Rust | 📅 2026-09-09
...
* Uses [fsrs-rs](https://github.com/open-spaced-repetition/fsrs-rs) ⭐ 416 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 for FSRS-6 scheduling.
...
* Quanta uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09 for native FSRS-6 scheduling across all review modes (classic, endless, exam simulation).
...
* The [GPLv3-licensed browser extension](https://github.com/mengxi-ream/read-frog) ⭐ 9,569 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-09 is available for Chrome, Edge, and Firefox.
* Its end-to-end spaced-repetition system uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09 with the FSRS-6 model, middleware-based scheduling, and policy-driven review queues. A per-Notebase optimizer personalizes scheduling from review history.
...
Rember uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09.
...
Revu uses [swift-fsrs](https://github.com/open-spaced-repetition/swift-fsrs) ⭐ 99 | 🐛 6 | 🌐 Swift | 📅 2026-05-25.
...
spacedrep uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 481 | 🐛 0 | 🌐 Python | 📅 2026-08-09.
...
* [HiNote](https://github.com/CatMuse/HiNote) ⭐ 258 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-07 is a powerful Obsidian extension that helps you add comments to highlighted notes, use AI for thinking, and FSRS-6 for memory.
...
* [LearnKit](https://github.com/ctrlaltwill/LearnKit) ⭐ 169 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-06 helps you remember what you write. It brings flashcards, note review, tests, and AI-assisted study tools into Obsidian, so your vault becomes a place to learn, not just store information. It uses FSRS-6 for spaced repetition scheduling.

* [True Recall](https://github.com/pieralukasz/true-recall) ⭐ 61 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-04 is a next-gen spaced repetition system for Obsidian with AI card generation, local-first SQLite storage, Anki import/export, projects system, and comprehensive analytics. It uses FSRS-6 via [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09.
...
#### [SiYuan](https://github.com/siyuan-note/siyuan) ⭐ 46,238 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09
...
#### [TiddlyWiki](https://github.com/TiddlyWiki/TiddlyWiki5) ⭐ 8,645 | 🐛 1,164 | 🌐 JavaScript | 📅 2026-09-08
...
#### [Foliole](https://github.com/campfirium/foliole) ⭐ 121 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-09

Foliole is an approachable incremental reading app for making reading actually complete.

Open source, open data, local first.

Native incremental reading with integrated FSRS scheduling, powered by [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09.
...
* It uses [ts-fsrs](https://github.com/open-spaced-repetition/ts-fsrs) ⭐ 780 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09 to schedule reviews of JLPT N5 - N1 vocabulary and grammar flashcards.
...
* Available on web.
  ...
  LinGoat uses [py-fsrs](https://github.com/open-spaced-repetition/py-fsrs) ⭐ 481 | 🐛 0 | 🌐 Python | 📅 2026-08-09 (FSRS-6) for scheduling.
...
WordVault is a word study app for Scrabble/Boggle/other word games. It [uses the Go FSRS library](https://github.com/open-spaced-repetition/go-fsrs) ⭐ 144 | 🐛 4 | 🌐 Go | 📅 2026-07-25 for scheduling words, which show up as scrambled letters for the user to solve. This should hopefully be significally more efficient than the Leitner cardbox system previously in use in some word study apps.
...
* Benchmark: [open-spaced-repetition/srs-benchmark: A benchmark for spaced repetition schedulers/algorithms (github.com)](https://github.com/open-spaced-repetition/srs-benchmark) ⭐ 260 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-29
* Math:
  * [The Algorithm · open-spaced-repetition/awesome-fsrs Wiki](https://github.com/open-spaced-repetition/awesome-fsrs/wiki/The-Algorithm) ⭐ 681 | 🐛 6 | 📅 2026-09-01
* Dataset:
